...
function ModalAddProduct({ openModal, closeModal }) {
  ...
  const callApiPostProduct = () => {
    ...
    callApi(`https://goodmamabackend.herokuapp.com/products/`, body)
      .then((data) => {
        if (data.data) {
    ...
    <>
      <CModal visible={openModal} onClose={closeModal} backdrop="static">
        <CModalHeader onClose={closeModal}>
          <CModalTitle>Thêm sản phẩm</CModalTitle>
        </CModalHeader>
        <CModalBody>
          <CFormInput
            className="mb-3"
